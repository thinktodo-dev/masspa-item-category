...
var MasspaMenuImage = styled.img(_templateObject2, function (_ref2) {
  var mode = _ref2.mode;
...
var ArrowLeft = styled.img(_templateObject3);

var ArrowRight = styled.img(_templateObject4);
                    ...
                    if (mode === 2) {
                        ...
                        return React__default.createElement(
                          ...
                          React__default.createElement(
                            ...
                            React__default.createElement(
                              ...
                              React__default.createElement(
                                'div',
                                { className: 'masspa-item-category-title-2' },
                                item.title
                              )
                            )
                          ),
                      ...
                      if (animation === 'zoom') {
                        return React__default.createElement(
                          ...
                          React__default.createElement(
                            'div',
                            { className: 'masspa-item-category-title-1' },
                            item.title
                          ),
                          item.description !== null ? React__default.createElement('div', { className: 'masspa-item-category-text', dangerouslySetInnerHTML: { __html: '' + item.description } }) : React__default.createElement('div', null)
                        );
